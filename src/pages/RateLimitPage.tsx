    ...
    <div className="p-8">
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-geo-card border border-geo-border rounded-xl p-5">
          <div className="text-xs text-txt-muted mb-2">Device 제한 (분당)</div>
        ...
        <div className="bg-geo-card border border-geo-border rounded-xl p-5">
          <div className="text-xs text-txt-muted mb-2">차단된 디바이스</div>
      ...
      <div className="bg-geo-card border border-geo-border rounded-xl p-5">
        <h3 className="text-sm font-medium text-txt-primary mb-4">화이트리스트 현황</h3>
